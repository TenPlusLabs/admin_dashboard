 ...
 return (
        <main>
            <div className='container-fluid mt-5'>
                ...
                <div className='row'>
                    <h2 className='ml-5'>Media Edit</h2>
                         ...
                         <Close style={{marginLeft:'auto',color:'#333'}} className='mb-2 cursor-pointer' onClick={handleClose} />
                                <div className='d-flex'>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col">
                                            <div class="form-outline">
                                                <input type='text' placeholder='Alternate Text' className='form-control'/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        ...
                                        <div class="col">
                                            <div class="form-outline">
                                                <input type='image' alt='New Image' placeholder='Description' className='form-control'/>
                                            </div>
                                        </div>
                                    </div>
                                    <hr />
                            ...
                            &nbsp;&nbsp;
                            <span className='btn btn-danger' onClick={handleClose}>Discard</span>
                         </Box>
                    </Modal>
