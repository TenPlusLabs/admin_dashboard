...
export default function PortalNewForm() {
    return (
        <div>
            <form class="form" action="">
                <div class="row mb-4">
                    ...
                    <div class="col">
                        <div class="form-outline">
                        <input type="text" id="title" class="form-control" placeholder="Portal Title" />
                        </div>
                    </div>
                </div>
                <div class="row mb-4">
                    <div class="col">
                        <div class="form-outline">
                        <input type="text" id="url" class="form-control" placeholder="Portal URL" />
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-outline">
                        <input type="text" id="desc" class="form-control" placeholder="Portal Description" />
                        </div>
                    </div>
                </div>
                <div class="row mb-4">
...
export function PortalEditForm() {
    return (
        <div>
            <form class="form" action="">
                <div class="row mb-4">
