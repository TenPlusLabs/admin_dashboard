...
const Rows = [
  {
    id: 1,
    form_name: "TenPlus Labs",
    form_page: "https://tenplus.com",
    total_unread: "01",
    total_response: "05",
  },
  {
...
const Table = (props) => {
  ...
  return (
    <tr>
      <td>{id}</td>
      <td className="page_title" colspan="2" style={{ width: "200px" }}>
        {" "}
        {form_name}
          ...
          <Tabs>
            <div className="d-flex justify-content-around mb-3">
              <TabList className="col-md-5 d-flex justify-content-around ml-5">
                <Tab>
                  <button className="btn active">All(3)</button>
                </Tab>
                <Tab>
                  <button className="btn">Published(0)</button>
                </Tab>
                <Tab>
                  <button className="btn active">Draft(3)</button>
                </Tab>
                <Tab>
                  <button className="btn">Bin(0)</button>
                </Tab>
              </TabList>
